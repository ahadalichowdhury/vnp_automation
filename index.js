  ...
  try {
    ...
    for (const item of sheetData) {
      ...
      if (!hashMap[item['Property Name']]) {
        ...
        hotels[hashMap[item['Property Name']] - 1].idList.push(item['Reservation ID']);
      }
    }
...
async function loginToExpediaPartner(
  ...
  try {
    ...
    for (const item of sheetData) {
      ...
      try {
        await page.waitForSelector('.tpg-navigation__logo_container', { visible: true, timeout: 5000 });
